...
public class CohortReviewController implements CohortReviewApiDelegate {
  ...
  public ResponseEntity<org.pmiops.workbench.model.CohortReview> createCohortReview(
    ...
    org.pmiops.workbench.model.CohortReview responseReview = cohortReviewMapper
        .toApiCohortReviewWithPaging(cohortReview, pageRequest);
  ...
  public ResponseEntity<org.pmiops.workbench.model.ParticipantCohortStatus>
    ...
    return ResponseEntity.ok(cohortReviewMapper.toApiParticipant(status));
  }
  ...
  public ResponseEntity<org.pmiops.workbench.model.ParticipantCohortStatus>
    ...
    return ResponseEntity.ok(cohortReviewMapper.toApiParticipant(participantCohortStatus));
  }
