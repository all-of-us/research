...
import org.pmiops.workbench.cohortreview.CohorReviewMapper;
...
public class CohortReviewController implements CohortReviewApiDelegate {
  ...
  private CohorReviewMapper cohorReviewMapper;
  ...
  CohortReviewController(
      ...
      CohorReviewMapper cohorReviewMapper) {
    ...
    this.cohorReviewMapper = cohorReviewMapper;
  }
  ...
  public ResponseEntity<org.pmiops.workbench.model.CohortReview> createCohortReview(
    ...
    responseReview.setParticipantCohortStatuses(
        paginatedPCS.stream().map(cohorReviewMapper::toApiParticipant).collect(Collectors.toList()));
  ...
  public ResponseEntity<org.pmiops.workbench.model.ParticipantCohortStatus>
    ...
    return ResponseEntity.ok(cohorReviewMapper.toApiParticipant(status));
  }
  ...
  public ResponseEntity<org.pmiops.workbench.model.CohortReview> getParticipantCohortStatuses(
    ...
    org.pmiops.workbench.model.CohortReview responseReview =
        TO_CLIENT_COHORTREVIEW_WITH_PAGING.apply(cohortReview, pageRequest);
    responseReview.setParticipantCohortStatuses(
        participantCohortStatuses.stream().map(cohorReviewMapper::toApiParticipant).collect(Collectors.toList()));
  ...
  public ResponseEntity<org.pmiops.workbench.model.ParticipantCohortStatus>
    ...
    return ResponseEntity.ok(cohorReviewMapper.toApiParticipant(participantCohortStatus));
  }
