...
public class CohortReviewController implements CohortReviewApiDelegate {
   ...
   * (generated by Swagger).
   */
  private static final BiFunction<DbCohortReview, PageRequest, CohortReview>
   ...
   * (generated by Swagger).
   */
  private static final Function<DbCohortReview, CohortReview> TO_CLIENT_COHORTREVIEW =
      cohortReview ->
          new CohortReview()
              .cohortReviewId(cohortReview.getCohortReviewId())
  ...
  private static final Function<ParticipantCohortAnnotation, DbParticipantCohortAnnotation>
  ...
  private static final Function<DbParticipantCohortAnnotation, ParticipantCohortAnnotation>
  ...
  public ResponseEntity<org.pmiops.workbench.model.CohortReview> createCohortReview(
    ...
    responseReview.setParticipantCohortStatuses(
        paginatedPCS.stream()
            .map(pcs -> TO_CLIENT_PARTICIPANT.apply(pcs, getGenderRaceEthnicityMap()))
  ...
  public ResponseEntity<org.pmiops.workbench.model.ParticipantCohortStatus>
    ...
    return ResponseEntity.ok(TO_CLIENT_PARTICIPANT.apply(status, getGenderRaceEthnicityMap()));
  }
  ...
  public ResponseEntity<org.pmiops.workbench.model.ParticipantCohortStatus>
    ...
    return ResponseEntity.ok(
        TO_CLIENT_PARTICIPANT.apply(participantCohortStatus, getGenderRaceEthnicityMap()));
  }
