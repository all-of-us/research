...
export const defaultAnswersDisseminateResearchFindings = [
  {
    id:
      FIELD.DISSEMINATE_RESEARCH_FINDINGS
  ...
  {
    id:
      FIELD.DISSEMINATE_RESEARCH_FINDINGS.presentationAtCommunityForumsCheckbox,
    selected: true,
  },
  {
...
export const defaultAnswersAnticipatedOutcomesFromResearch = [
  ...
  {
    id:
      FIELD.DESCRIBE_ANTICIPATED_OUTCOMES
        .seeksToReduceHealthDisparitiesCheckbox,
    selected: true,
  },
  {
    id:
      FIELD.DESCRIBE_ANTICIPATED_OUTCOMES.seeksToDevelopRiskAssessmentCheckbox,
    selected: true,
  },
  {
    id:
