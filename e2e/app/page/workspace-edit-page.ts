...
export const LabelAlias = {
  ...
  PRESENTATION_AT_CONFERENCES:
    'Presentation at national or international scientific conferences',
  PRESENTATION_AT_COMMUNITY_FORUMS:
    'Presentation at community forums or advisory groups',
  PRESS_RELEASE:
    'Press release or media article covering scientific publication',
  PUBLICATION_IN_COMMUNITY_JOURNALS:
    'Publication in community-based journals or blog',
  PUBLICATION_IN_PERSONAL_BLOG: 'Publication of article in a personal blog',
  OTHER: 'Other',
  INCREASE_WELLNESS:
    'This research project seeks to increase wellness and resilience',
  ...
  SEEKS_TO_DEVELOP_RISK_ASSESSMENT:
    'seeks to develop improved risk assessment and prevention strategies to preempt disease',
  SEEKS_TO_PROVIDE_ACCURATE_DIAGNOSIS:
    'seeks to provide earlier and more accurate diagnosis to decrease illness burden',
  ...
  NO_FOCUS_ON_UNDERREPRESENTED_POPULATION:
  ...
  DISABILITY_STATUS_WITH_DISABILITY:
    'Participants with a physical and/or cognitive disability',
  NO_REQUEST_REVIEW:
    'No, I have no concerns at this time about potential stigmatization',
  YES_REQUEST_REVIEW:
    'Yes, I would like to request a review of my research purpose',
  SHARE_WITH_COLLABORATORS:
    'Share workspace with the same set of collaborators', // visible when clone workspace
};
...
export const FIELD = {
  ...
  workspaceNameTextbox: {
    textOption: {
      name: LabelAlias.WORKSPACE_NAME,
      ancestorLevel: 2,
  ...
  shareWithCollaboratorsCheckbox: {
    textOption: {
      name: LabelAlias.SHARE_WITH_COLLABORATORS,
  ...
  PRIMARY_PURPOSE: {
    ...
    researchPurposeCheckbox: {
      textOption: {
        name: LabelAlias.RESEARCH_PURPOSE,
        ancestorLevel: 3,
        type: ElementType.Checkbox,
      },
    },
    diseaseFocusedResearchCheckbox: {
      textOption: {
        name: LabelAlias.DISEASE_FOCUSED_RESEARCH,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    ...
    methodsDevelopmentValidationStudyCheckbox: {
      textOption: {
        name: LabelAlias.METHODS_DEVELOPMENT,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    researchControlCheckbox: {
      textOption: {
        name: LabelAlias.RESEARCH_CONTROL,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    geneticResearchCheckbox: {
      textOption: {
        name: LabelAlias.GENETIC_RESEARCH,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    socialBehavioralResearchCheckbox: {
      textOption: {
        name: LabelAlias.SOCIAL_BEHAVIORAL_RESEARCH,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    populationHealthCheckbox: {
      textOption: {
        name: LabelAlias.POPULATION_HEALTH,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    ethicalLegalSocialImplicationsResearchCheckbox: {
      textOption: {
        name: LabelAlias.ETHICAL_LEGAL_SOCIAL_IMPLICATIONS,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    drugTherapeuticsDevelopmentResearchCheckbox: {
      textOption: {
        name: LabelAlias.DRUG_THERAPEUTIC_DEVELOPMENT,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    educationPurposeCheckbox: {
      textOption: {
        name: LabelAlias.EDUCATION_PURPOSE,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    forProfitPurposeCheckbox: {
      textOption: {
        name: LabelAlias.FOR_PROFIT_PURPOSE,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
  ...
  RESEARCH_PURPOSE_SUMMARY: {
    ...
    scientificQuestionsIntentToStudyTextarea: {
      textOption: {
        containsText: LabelAlias.INTENT_TO_STUDY,
        ancestorLevel: 3,
    ...
    scientificApproachesToUseTextarea: {
      textOption: {
        containsText: LabelAlias.SCIENTIFIC_APPROACHES,
        ancestorLevel: 3,
        type: ElementType.Textarea,
      },
    },
    anticipatedFindingsFromStudyTextarea: {
      textOption: {
        containsText: LabelAlias.ANTICIPATED_FINDINGS,
        ancestorLevel: 3,
        type: ElementType.Textarea,
      },
    },
  ...
  DISSEMINATE_RESEARCH_FINDINGS: {
    ...
    publicationInScientificJournalsCheckbox: {
      textOption: {
        containsText: LabelAlias.PUBLICATION_IN_JOURNALS,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    socialMediaCheckbox: {
      textOption: {
        containsText: LabelAlias.SOCIAL_MEDIA,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    presentationAtScientificConferencesCheckbox: {
      textOption: {
        containsText: LabelAlias.PRESENTATION_AT_CONFERENCES,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    ...
    pressReleaseCheckbox: {
      textOption: {
        containsText: LabelAlias.PRESS_RELEASE,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
  ...
  DESCRIBE_ANTICIPATED_OUTCOMES: {
    ...
    seeksIncreaseWellnessCheckbox: {
      textOption: {
        containsText: LabelAlias.INCREASE_WELLNESS,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    ...
    seeksToReduceBurdenCheckbox: {
      textOption: {
        containsText: LabelAlias.SEEKS_TO_REDUCE_BURDEN,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
  ...
  POPULATION_OF_INTEREST: {
    ...
    yesRadiobutton: {
      textOption: {
        containsText: LabelAlias.YES_FOCUS_ON_UNDERREPRESENTED_POPULATION,
        type: ElementType.RadioButton,
      },
    },
    noRadiobutton: {
      textOption: {
        containsText: LabelAlias.NO_FOCUS_ON_UNDERREPRESENTED_POPULATION,
        type: ElementType.RadioButton,
      },
    },
    raceMultiAncestryCheckbox: {
      textOption: {
        containsText: LabelAlias.RACE_MULTI_ANCESTRY,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    ageGroupsAdolescentsCheckbox: {
      textOption: {
        containsText: LabelAlias.AGE_GROUPS_ADOLESCENTS,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    sexAtBirthCheckbox: {
      textOption: {
        containsText: LabelAlias.SEX_AT_BIRTH,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    genderIdentityCheckbox: {
      textOption: {
        containsText: LabelAlias.GENDER_IDENTITY,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    geographyRuralCheckbox: {
      textOption: {
        containsText: LabelAlias.GEOGRAPHY_RURAL,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
    educationLevelHighSchoolCheckbox: {
      textOption: {
        containsText: LabelAlias.EDUCATION_LEVEL_HIGHSCHOOL,
        ancestorLevel: 2,
        type: ElementType.Checkbox,
      },
    },
  ...
  REQUEST_FOR_REVIEW: {
    ...
    yesRequestReviewRadiobutton: {
      textOption: {
        containsText: LabelAlias.YES_REQUEST_REVIEW,
        type: ElementType.RadioButton,
      },
    },
    noRequestReviewRadiobutton: {
      textOption: {
        containsText: LabelAlias.NO_REQUEST_REVIEW,
        type: ElementType.RadioButton,
      },
    },
  },
...
export default class WorkspaceEditPage extends WorkspaceBase {
  ...
  async getDuplicateWorkspaceButton(): Promise<Button> {
    ...
    return new Button(
      this.page,
      '//*[text()="Duplicate Workspace" and @role="button"]'
    );
  }
  ...
  async getUpdateWorkspaceButton(): Promise<Button> {
    return new Button(
      this.page,
      '//*[text()="Update Workspace" and @role="button"]'
    );
  }
  ...
  async getWorkspaceNameTextbox(): Promise<Textbox> {
    return await Textbox.findByName(
      this.page,
      FIELD.workspaceNameTextbox.textOption
    );
  }

  question1ResearchPurpose(): WebComponent {
    return new WebComponent(
      this.page,
      FIELD.PRIMARY_PURPOSE.researchPurposeCheckbox.textOption
    );
  }

  question1EducationalPurpose(): WebComponent {
    return new WebComponent(
      this.page,
      FIELD.PRIMARY_PURPOSE.educationPurposeCheckbox.textOption
    );
  }

  question1ForProfitPurpose(): WebComponent {
    return new WebComponent(
      this.page,
      FIELD.PRIMARY_PURPOSE.forProfitPurposeCheckbox.textOption
    );
  }

  question1OtherPurpose(): WebComponent {
    return new WebComponent(
      this.page,
      FIELD.PRIMARY_PURPOSE.otherPurposeCheckbox.textOption
    );
  }

  question1DiseaseFocusedResearch(): WebComponent {
    return new WebComponent(
      this.page,
      FIELD.PRIMARY_PURPOSE.diseaseFocusedResearchCheckbox.textOption
    );
  }

  question2ScientificQuestionsIntendToStudy(): WebComponent {
    return new WebComponent(
      this.page,
  ...
  question2ScientificApproaches(): WebComponent {
    return new WebComponent(
      this.page,
      FIELD.RESEARCH_PURPOSE_SUMMARY.scientificApproachesToUseTextarea.textOption
    );
  }

  question2AnticipatedFindings(): WebComponent {
    return new WebComponent(
      this.page,
      FIELD.RESEARCH_PURPOSE_SUMMARY.anticipatedFindingsFromStudyTextarea.textOption
    );
  }
  ...
  increaseWellnessResilience(): WebComponent {
    return new WebComponent(
      this.page,
      FIELD.DESCRIBE_ANTICIPATED_OUTCOMES.seeksIncreaseWellnessCheckbox.textOption
    );
  }
   ...
   * @param {string} value
   */
  async selectCdrVersion(
    value: string = config.defaultCdrVersionName
  ): Promise<string> {
  ...
  async expandResearchPurposeGroup(yesOrNo = true): Promise<void> {
    ...
    const researchPurpose = this.question1ResearchPurpose();
   ...
   */
  async fillOutDiseaseFocusedResearch(
    diseaseName = 'diabetic cataract'
  ): Promise<void> {
    const diseaseNameComponent = this.question1DiseaseFocusedResearch();
  ...
  async fillOutOtherPurpose(value?: string): Promise<void> {
    ...
    const otherPurpose = this.question1OtherPurpose();
  ...
  async requestForReviewRadiobutton(selected: boolean): Promise<void> {
    let radioComponent;
    if (selected) {
      radioComponent = new WebComponent(
        this.page,
        FIELD.REQUEST_FOR_REVIEW.yesRequestReviewRadiobutton.textOption
      );
    } else {
      radioComponent = new WebComponent(
        this.page,
        FIELD.REQUEST_FOR_REVIEW.noRequestReviewRadiobutton.textOption
      );
    }
  ...
  async clickShareWithCollaboratorsCheckbox(): Promise<void> {
    const elemt = await Checkbox.findByName(
      this.page,
      FIELD.shareWithCollaboratorsCheckbox.textOption
    );
    await elemt.check();
  }
}
