...
const LabelAlias = {
  WILL_USE_OLD_CDR_VERSION:
    'I will use this workspace to complete an existing study or replicate a previous study.',
...
const FIELD = {
  willUseCheckbox: {
    textOption: {
      name: LabelAlias.WILL_USE_OLD_CDR_VERSION,
      type: ElementType.Checkbox,
    },
  },
  willIdentifyCheckbox: {
    textOption: {
      name: LabelAlias.WILL_IDENTIFY_OLD_CDR_VERSION,
      type: ElementType.Checkbox,
    },
  },
  continueButton: {
...
export default class OldCdrVersionModal extends Modal {
  ...
  async getWillUseCheckbox(): Promise<Checkbox> {
    return Checkbox.findByName(
      this.page,
      FIELD.willUseCheckbox.textOption,
      this
    );
  }
  ...
  async getWillIdentifyCheckbox(): Promise<Checkbox> {
    return Checkbox.findByName(
      this.page,
      FIELD.willIdentifyCheckbox.textOption,
      this
    );
  }
